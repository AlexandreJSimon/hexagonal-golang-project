...
// Source: ./internal/application/port (interfaces: UserRepository)
//
// Generated by this command:
//
//	mockgen -destination=mocks/user_repository_mock.go -package=mocks ./internal/application/port UserRepository
//
