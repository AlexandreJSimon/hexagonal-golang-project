...
mocks:
	$(MOCKGEN) -destination=mocks/user_service_mock.go -package=mocks github.com/AlexandreJSimon/hexagonal-golang-project/internal/application/user UserServiceProvider
